                        ...
                        <table class="table" style="width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 15%; text-align: left;">Seats Available</th>
                                    <th style="width: 25%; text-align: right;">Ticket Price</th>
                            ...
                            <tbody>
                                ...
                                <tr id="movie_{{ $movie->id }}">
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($movie->date_showing)->format('F j, Y') }}</td>
